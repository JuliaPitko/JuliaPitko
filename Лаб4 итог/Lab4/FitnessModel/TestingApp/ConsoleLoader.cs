        ...
        private static double ChooseSwimmingStyle()
        {
            while (true)
            {
                try
                {
                    ...
                    SwimmingEnum swimmingStyle = SwimmingEnum.QuickCrawl;
                    var kkal = 6;
                    switch (style)
                    {
                        case 1:
                            {
                                swimmingStyle = SwimmingEnum.SlowBrace;
                                kkal = 6;
                                break;
                            }
                        case 2:
                            {
                                swimmingStyle = SwimmingEnum.QuickCrawl;
                                kkal = 7;
                                break;
                            }
                        case 3:
                            {
                                swimmingStyle = SwimmingEnum.SlowСrawl;
                                kkal = 8;
                                break;
                            }
                        default:
